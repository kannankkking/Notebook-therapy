...
const one = new URL("../images/section2_2_3.jpg", import.meta.url);
const two = new URL("../images/section2_2_2.jpg", import.meta.url);
const three = new URL("../images/section2_2_1.jpg", import.meta.url);
const four = new URL("../images/section2_2_4.jpg", import.meta.url);
const five = new URL("../images/section2_2_5.jpg", import.meta.url);
const six = new URL("../images/section2_2_6.jpg", import.meta.url);
const seven = new URL("../images/section2_2_7.jpg", import.meta.url);
const eight = new URL("../images/section2_2_8.jpg", import.meta.url);
